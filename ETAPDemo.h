// ETAPDemo.h : main header file for the ETAPDEMO application
//

#if !defined(AFX_ETAPDEMO_H__D1EBE189_96C4_467A_9B73_E1901F68098C__INCLUDED_)
#define AFX_ETAPDEMO_H__D1EBE189_96C4_467A_9B73_E1901F68098C__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// CETAPDemoApp:
// See ETAPDemo.cpp for the implementation of this class
//
#include "FOProjectApp.h"
#define REG_EDITPAD_IDE     _T ("Software\\UCanCode Software\\ETAPDemo\\IDE")
#define MY_PROP_DISTANCE FO_CUSTOM_PROP_ID + 1
#define MY_PROP_VALUE1 FO_CUSTOM_PROP_ID + 1
#define MY_PROP_VALUE2 FO_CUSTOM_PROP_ID + 2
#define MY_PROP_VALUE3 FO_CUSTOM_PROP_ID + 3
#define MY_PROP_VALUE4 FO_CUSTOM_PROP_ID + 4
#define MY_PROP_VALUE5 FO_CUSTOM_PROP_ID + 5

#define MY_PROP_VALUE6 FO_CUSTOM_PROP_ID + 6
...
#define MY_BOX_STATE	FO_CUSTOM_PROP_ID + 7


 
//===========================================================================
// Summary:
//     The CNewImageList class derived from CImageList
//      New Image List
//===========================================================================

class CNewImageList : public CImageList  
{
public:
	
	//-----------------------------------------------------------------------
	// Summary:
	// New Image List, Constructs a CNewImageList object.
	//		Returns A  value.
	CNewImageList();
	
	//-----------------------------------------------------------------------
	// Summary:
	// C New Image List, Destructor of class CNewImageList
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns A  value.
	virtual ~CNewImageList();
	
	
	//-----------------------------------------------------------------------
	// Summary:
	// Create X, You construct a CNewImageList object in two steps. First call the constructor, then call Create, which creates the object.
	//		Returns TRUE on success; FALSE otherwise.  
	// Parameters:
	//		nID---I D, Specifies A 16-bit unsigned integer on Windows versions 3.0 and 3.1; a 32-bit unsigned integer on Win32.
	BOOL CreateX(UINT nID);
	...
	// Parameters:
	//		nID---I D, Specifies A 16-bit unsigned integer on Windows versions 3.0 and 3.1; a 32-bit unsigned integer on Win32.  
	//		colMask---colMask, Specifies A 32-bit value used as a color value.
	BOOL CreateX(UINT nID, COLORREF colMask);
	...
	//		cx---Specifies A integer value.  
	//		colMask---colMask, Specifies A 32-bit value used as a color value.
	BOOL CreateX(UINT nID, int cx, COLORREF colMask);
	...
	BOOL CreateX(UINT nID, int cx, int cy);
	...
	//		cy---Specifies A integer value.  
	//		colMask---colMask, Specifies A 32-bit value used as a color value.
	BOOL CreateX(UINT nID, int cx, int cy, COLORREF colMask);
};
...
//===========================================================================
// Summary:
//     The CETAPDemoApp class derived from CFOProjectApp
//      E T A P Demo Application
//===========================================================================

class CETAPDemoView;
class CETAPDemoApp : public CFOProjectApp
{
public:
	
	//-----------------------------------------------------------------------
	// Summary:
	// E T A P Demo Application, Constructs a CETAPDemoApp object.
	//		Returns A  value.
	CETAPDemoApp();

// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CETAPDemoApp)
	public:
	...
	CString XGetBaseFileName(const CString& strFileName);

	// Find project view.
	CETAPDemoView *FindProjectFilesView(CString strFileName);
	...
	// With Dot Show, This member sets TRUE if it is right.  
	BOOL bWithDotShow;
	...
	// This member specify CNewImageList object.  
	CNewImageList m_drawlist;
// Implementation
	//{{AFX_MSG(CETAPDemoApp)
...
/////////////////////////////////////////////////////////////////////////////
extern CETAPDemoApp theApp;
//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_ETAPDEMO_H__D1EBE189_96C4_467A_9B73_E1901F68098C__INCLUDED_)
